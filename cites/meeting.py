...
@meeting.route("/meeting/1/printouts/verified/pigeon_holes_verified")
@auth_required
@sugar.templated("meeting/print_pigeon_holes.html")
def verified_pigeon_holes():
    ...
    page_info = {
        ...
        "url": "meeting.verified_pigeon_holes"
    }
...
@meeting.route("/meeting/1/printouts/verified/pigeon_holes_attended")
@auth_required
@sugar.templated("meeting/print_pigeon_holes.html")
def attended_pigeon_holes():
    ...
    page_info = {
        ...
        "url": "meeting.attended_pigeon_holes"
    }
